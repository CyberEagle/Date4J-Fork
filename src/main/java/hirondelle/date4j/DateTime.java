...
public final class DateTime implements Comparable<DateTime>, Serializable {
    ...
    /**
     * Constructor taking a millisecond value and a {@link java.util.TimeZone}.
     * This constructor may be use to convert a <tt>java.util.Date</tt> into a <tt>DateTime</tt>.
     * <p/>
     * <P>To use nanosecond precision, please use {@link #forInstantNanos(long, java.util.TimeZone)} instead.
     *
    ...
    /**
     * Constructor taking a millisecond value and a {@link java.util.TimeZone}.
     * This constructor may be use to convert a <tt>java.util.Date</tt> into a <tt>DateTime</tt>, getting just the time.
     * <p/>
     * <P>To use nanosecond precision, please use {@link #forInstantNanos(long, java.util.TimeZone)} instead.
     *
     * @param aMilliseconds must be in the range corresponding to the range of dates supported by this class (year 1..9999); corresponds
     *                      to a millisecond instant on the time-line, measured from the epoch used by {@link java.util.Date}.
     */
    public static DateTime forInstantTimeOnly(long aMilliseconds, TimeZone aTimeZone) {
        Calendar calendar = new GregorianCalendar(aTimeZone);
        calendar.setTimeInMillis(aMilliseconds);
        int hour = calendar.get(Calendar.HOUR_OF_DAY); // 0..23
        int minute = calendar.get(Calendar.MINUTE);
        ...
        int milliseconds = calendar.get(Calendar.MILLISECOND);
        int nanoseconds = milliseconds * 1000 * 1000;
        return new DateTime(null, null, null, hour, minute, second, nanoseconds);
    }

    /**
     * Constructor taking a nanosecond value and a {@link java.util.TimeZone}.
     * <p/>
     * <P>To use milliseconds instead of nanoseconds, please use {@link #forInstant(long, java.util.TimeZone)}.
     *
     ...
     * <P>Combines the return value of {@link System#currentTimeMillis()} with the given {@link java.util.TimeZone}.
     * <p/>
     ...
     * <P>Only millisecond precision is possible for this method.
     */
    public static DateTime nowTimeOnly(TimeZone aTimeZone){
        return forInstantTimeOnly(System.currentTimeMillis(), aTimeZone);
    }

    /**
     * Return the current date.
     * <P>As in {@link #now(java.util.TimeZone)}, but truncates the time portion, leaving only year-month-day.
     */
     ...
     * To retain nanosecond accuracy, please use {@link #getNanosecondsInstant(java.util.TimeZone)} instead.
     ...
     * you should likely use {@link #getMilliseconds(java.util.TimeZone)} instead.
     * <P>Requires year-month-day to be present; if not, a runtime exception is thrown.
     */
     ...
     * <P>See {@link #getWeekIndex(hirondelle.date4j.DateTime)} as well, which takes an arbitrary date to define
     * day 1 of week 1.
     * <P>Requires year-month-day to be present; if not, a runtime exception is thrown.
     */
     ...
     * Return <tt>true</tt> only if this <tt>DateTime</tt> comes before the given parameter, according to {@link #compareTo(hirondelle.date4j.DateTime)}.
     */
     ...
     * Return <tt>true</tt> only if this <tt>DateTime</tt> comes after the given parameter, according to {@link #compareTo(hirondelle.date4j.DateTime)}.
     */
     ...
     *
     * @param aPrecision takes any value <i>except</i> {@link hirondelle.date4j.DateTime.Unit#NANOSECONDS} (since it makes no sense to truncate to the highest
     *                   available precision).
     */
     ...
     * (and only then) the given {@link hirondelle.date4j.DateTime.DayOverflow} policy applied, and the day-of-the-month is adusted accordingly.
     * <p/>
     ...
     * <P>This method has nearly the same behavior as {@link #plus(Integer, Integer, Integer, Integer, Integer, Integer, Integer, hirondelle.date4j.DateTime.DayOverflow)},
   ...
   */
     ...
     * <p/>
     * <P>If months, weekdays, or AM/PM indicators are output as localizable text, you must use {@link #format(String, java.util.Locale)}.
     *
  ...
  /* The following 7 items represent the parsed form of a DateTime. */
     ...
     * <p/>
     * <P>Use of this method is likely relatively rare; it should be used only if the output of {@link #format(String, java.util.Locale)}  is
     * inadequate.
     *
     * @param aFormat         uses the <a href="#FormattingLanguage">formatting mini-language</a> defined in the class comment.
    ...
    /**
     * Return <tt>true</tt> only if this date is in the future, with respect to {@link #now(java.util.TimeZone)}.
     */
    ...
    /**
     * Return <tt>true</tt> only if this date is in the past, with respect to {@link #now(java.util.TimeZone)}.
     */
    ...
    /**
     * Return a <tt>DateTime</tt> corresponding to a change from one {@link java.util.TimeZone} to another.
     * <p/>
