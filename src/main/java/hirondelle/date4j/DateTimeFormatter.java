...
/**
 Formats a {@link hirondelle.date4j.DateTime}, and implements {@link hirondelle.date4j.DateTime#format(String)}.
 
 <P>This class defines a mini-language for defining how a {@link hirondelle.date4j.DateTime} is formatted.
 See {@link hirondelle.date4j.DateTime#format(String)} for details regarding the formatting mini-language.
...
final class DateTimeFormatter {
  ...
  /**
   ...
   @param aFormat uses the syntax described by {@link hirondelle.date4j.DateTime#format(String)}.
   */
  ...
  /**
   ...
   @param aFormat must match the syntax described by {@link hirondelle.date4j.DateTime#format(String)}.
  ...
  /**  Format a {@link hirondelle.date4j.DateTime}.  */
